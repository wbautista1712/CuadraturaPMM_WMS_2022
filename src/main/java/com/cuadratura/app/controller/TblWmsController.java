...
public class TblWmsController {
	...
	public ResponseEntity<String> crearCuadraturaWMS(@RequestParam String fechaProceso, @RequestParam String idCD)
			throws Exception {
		LOGGER.info("inicio");
	...
	public void exportFotoWmsByCargaExcel(@RequestParam Integer idCargaWMS, HttpServletResponse response)
