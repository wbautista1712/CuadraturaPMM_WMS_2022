...
public class AjustePmmWmsRepositoryImpl implements AjustePmmWmsRepositoryCustom {
	...
	public List<Object[]> getAllBolsaSdi(){
		String sql =  "	SELECT ATE.TRANS_USER, ATE.TRANS_BATCH_DATE, ATE.TRANS_SOURCE, ATE.TRANS_AUDITED, ATE.TRANS_SEQUENCE, ATE.INV_MRPT_CODE,			"+
				...
				"		 DATE(NOW()) AS TRANS_BATCH_DATE,         "+
				"		'Ajuste Cuadratura' AS TRANS_SOURCE,    	"+
				"		'F' AS TRANS_AUDITED,      		"+
			
				"		AJ.idAjuste_PMM_WMS AS TRANS_SEQUENCE,    		"+
			
				"		'MV' AS INV_MRPT_CODE,    	"+
				"		AJ.sugerenciaAjuste AS TRANS_QTY,        	"+
	...
	public void updateAjustePmmWms(Integer idAjustePMMWMS) {
		...
		String query = "UPDATE cuadratura.ajuste_pmm_wms "
				+ "SET estado=:estado "
